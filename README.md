...
2.  [Biology Fundamentals for Bioinformatics](https://www.bioinfolearninfinite.com/biology-fundamentals-for-bioinformatics)
3.  [Statistical Analysis and Inference](https://www.bioinfolearninfinite.com/statistical-analysis-and-inference)
4.  [Bioinformatics core skills](https://www.bioinfolearninfinite.com/bioinformatics-core-skills)
5.  [Bioinformatics Data Analysis-Focused (NGS)](https://www.bioinfolearninfinite.com/bioinformatics-data-analysis-focused-ngs)
6.  [Machine Learning](https://www.bioinfolearninfinite.com/machine-learning)
7.  [Neuro-imaging data analysis](https://www.bioinfolearninfinite.com/neuroimaging-data-analysis)

## Explore our Learning Center

Here are some useful links and platforms for bioinformatics-directed analysis.

| Platform | Description | Link to Website |
| :--- | :--- | :--- |
| Bulk RNA-seq | Covers basic steps involved in RNA-seq analysis | [Bulk RNA-seq by Harvard Chan Bioinformatics Core (HBC)](https://hbctraining.github.io/DGE_workshop/lessons/01_DGE_setup_and_overview.html) |
